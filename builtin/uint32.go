...
// XGo_LT implements func (a uint32) < (b uint32) bool
func (a Uint32) XGo_LT(b Uint32) bool {
	return primitive.Number(a) < primitive.Number(b)
}

// XGo_LE implements func (a uint32) <= (b uint32) bool
func (a Uint32) XGo_LE(b Uint32) bool {
	return primitive.Number(a) <= primitive.Number(b)
}

// XGo_GT implements func (a uint32) > (b uint32) bool
func (a Uint32) XGo_GT(b Uint32) bool {
	return primitive.Number(a) > primitive.Number(b)
}

// XGo_GE implements func (a uint32) >= (b uint32) bool
func (a Uint32) XGo_GE(b Uint32) bool {
	return primitive.Number(a) >= primitive.Number(b)
}
